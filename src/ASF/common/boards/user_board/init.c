...
void board_init(void)
{
	...
	// initializing provisioning pin
	ioport_set_pin_dir(provision_button_pin, IOPORT_DIR_INPUT);
	ioport_set_pin_mode(provision_button_pin, IOPORT_MODE_PULLUP);// button connected to ground
